        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
          {stats.map((stat, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="bg-black/50 backdrop-blur-sm border border-green-500/20 rounded-lg p-6 text-center"
            >
        ...
        <div className="grid md:grid-cols-2 gap-10 items-center">
          ...
          >
            ...
            <div className="flex flex-wrap gap-4">
              <div className="bg-black/50 backdrop-blur-sm border border-green-500/20 rounded-full px-4 py-2 text-sm">
                CertiK Audited
              </div>
              <div className="bg-black/50 backdrop-blur-sm border border-green-500/20 rounded-full px-4 py-2 text-sm">
                SlowMist Verified
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="aspect-video rounded-lg overflow-hidden border border-green-500/20 bg-black/50">
